...
import ai.flowstorm.core.type.DynamicMutableList
...
class SampleApi(dialogue: BasicDialogue) : DialogueApi(dialogue) {
    ...
    private val target get() = target("https://admin.flowstorm.ai/user/applications") // base target, to be extended by params per call
