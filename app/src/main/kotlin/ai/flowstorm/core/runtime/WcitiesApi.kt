...
class WcitiesApi(dialogue: BasicDialogue) : DialogueApi(dialogue) {
    ...
    data class Category(val cat: Int, val id: Int, @JsonProperty("catname") val name: String) {
        ...
        companion object {
            val categoriesNames by lazy { RestClient.webTarget("https://core.develop.flowstorm.ai/files/assets/data/wcities-categories.json")
    ...
    open class Record(val id: Long, val name: String = "") {
        ...
        val imagefile = ""
        var imageBasePath = "https://core.develop.flowstorm.ai/proxy/"
