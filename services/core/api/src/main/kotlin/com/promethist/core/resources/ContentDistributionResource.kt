...
import com.promethist.core.model.SessionAttributes
...
interface ContentDistributionResource {
    ...
    data class ContentResponse(val application: Application, val user: User, val sessionAttributes: SessionAttributes)
}