...
object TtsServiceFactory {
    ...
    fun main(args: Array<String>) {
        val speech = create("google").speak(TtsRequest(text = "Třistatřicetři stříbrných stříkaček stříkalo přes třistatřicetři stříbrných střech.").set(TtsConfig.DEFAULT_CS))
