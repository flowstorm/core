...
import ai.flowstorm.client.audio.AudioDevice.Format
import ai.flowstorm.client.audio.SpeechDevice
import ai.flowstorm.client.audio.WakeWordConfig
import ai.flowstorm.client.audio.InputAudioDevice
...
class Microphone(speechDevice: SpeechDevice = NoSpeechDevice, wakeWord: WakeWordConfig? = null, private val channels: Int, private val channel: Int = 0) : InputAudioDevice(speechDevice) {
    ...
    private val wakeWordDetector by lazy {
        when (wakeWord?.type ?: WakeWordConfig.Type.none) {
            WakeWordConfig.Type.snowboy -> ai.flowstorm.client.audio.SnowboyWakeWordDetector(
                wakeWord!!,
